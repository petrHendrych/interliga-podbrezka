...
- fault into playing full -> 5€
- each fault costs the same amount as the numeric order of the fault -> 1 fault = 1€, 2 faults = 1€ + 2€,...
- missing 2nd to last throw -> 5€
- 5 games without fault -> 10€
