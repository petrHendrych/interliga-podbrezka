...
export default async function Home({
  ...
  return (
    <div className="p-4 md:p-8 max-w-6xl mx-auto w-full">
      ...
      <div className="sticky top-[calc(var(--app-header-height)+var(--app-safe-top))] z-30 -mx-4 md:-mx-8 mt-8 mb-8 border-b bg-background/95 px-4 py-3 backdrop-blur supports-backdrop-filter:bg-background/60 md:px-8">
        <SeasonLeagueFilter
              ...
              {trainers.map((trainer) => (
                ...
                >
                  <div className={PERSON_BODY}>
                    ...
                    <div className={TRAINER_STAT_GRID}>
                      ...
                      <div className={STAT_TILE}>
                        <span className={STAT_LABEL}>{dict.home.count4000}</span>
                        <span className={`${STAT_VALUE} font-bold`}>
                          {trainer.stats.count4000}
                          x
                        </span>
                      </div>
                      <div className={STAT_TILE}>
